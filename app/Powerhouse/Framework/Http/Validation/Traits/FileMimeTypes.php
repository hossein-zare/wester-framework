<?php
    ...
    trait FileMimeTypes
    {
         ...
         * @return string|null
         */
        public function guessMimeType($ext)
        {
            $ext = $this->convertToSpecifiedExtension($ext);
            $mimeType = array_search($ext, $this->defaultExtensions);
            return ($mimeType !== false) ? $mimeType : null;
        }

        /**
         * Convert undecided extension to a specified extension.
         * 
         * @param  string  $ext
         * @return string
         */
        public function convertToSpecifiedExtension($ext)
        {
            if ($ext === 'jpg') {
                return 'jpeg';
            }
         ...
         * @return bool
         */
        public function validImage($path, $ext)
        {
            ...
            $exif_imagetype = exif_imagetype($path);
            if ($exif_imagetype !== false && in_array($exif_imagetype, $exif) !== false)
                return true;
